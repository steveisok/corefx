...
DLLEXPORT int32_t SystemNative_EnumerateInterfaceAddresses(IPv4AddressFound onIpv4Found,
                                                           IPv6AddressFound onIpv6Found,
                                                           LinkLayerAddressFound onLinkLayerFound);

#if HAVE_RT_MSGHDR
DLLEXPORT int32_t SystemNative_EnumerateGatewayAddressesForInterface(uint32_t interfaceIndex,
