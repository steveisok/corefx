 ...
 */
DLLEXPORT int32_t SystemNative_FStat(intptr_t fd, struct FileStatus* output);
 ...
 * Returns 0 for success, -1 for failure. Sets errno on failure.
 */
DLLEXPORT int32_t SystemNative_Stat(const char* path, struct FileStatus* output);
 ...
 * Returns 0 for success, -1 for failure. Sets errno on failure.
 */
DLLEXPORT int32_t SystemNative_LStat(const char* path, struct FileStatus* output);
